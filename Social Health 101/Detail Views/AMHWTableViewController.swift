...
class AMHWTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        if indexPath.row == 0 {
            ...
            cell.AMHWP1ContLabel.text = "Formally called the Mental Health Association in Suffolk County, the Association for Mental Health and Wellness is a not-for-profit 501(c)(3) organization dedicated to promoting mental wellness by means of support services, education and advocacy."
            return cell
        }
        if indexPath.row == 1 {
