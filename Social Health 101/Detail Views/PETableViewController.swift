...
class PETableViewController: UITableViewController {
    ...
    var VCName = ""
    var PEP3TitlesArray = ["", "", "Stony Brook University Hospital Comprehensive Psychiatric Emergency Program (CPEP):", "Suffolk County Mobile Crisis Unit/Mental Health Hotline:", "National Suicide Prevention Lifeline:" ]
    var PEP3ContArray = ["", "", "CPEP is a hospital-based emergency psychiatric service open 24 hours a day, 7 days per week licensed by the New York State Office of Mental Health. The program exists to provide an organized system for responding to psychiatric emergencies for evaluation, intervention, treatment and referral for the residents of Suffolk County who have demonstrated a need for emergency psychiatric evaluation or treatment. The staff is a specially trained group of psychiatrists, social workers, nurses, and nursing assistants who are committed to providing the best emergency care to your family member, significant other or patient/client.Phone: 631-444-6050 ", "Offers crisis intervention services to individuals in the Community who are experiencing psychiatric/emotional problems. The team will make referrals for after care if necessary or arrange for hospitalization. Phone: 631-952-3333", "The National Suicide Prevention Lifeline provides free and confidential emotional support to people in suicidal crisis or emotional distress 24 hours a day, 7 days a week, across the United States. The Lifeline is comprised of a national network of over 160 local crisis centers, combining custom local care and resources with national standards and best practices. Phone: 800-273-8255 - suicidepreventionlifeline.org"]
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if indexPath.row == 1 {
            ...
            cell.PEP3TitleLabel.text = PEP3TitlesArray[indexPath.row]
            cell.PEP3ContLabel.text = PEP3ContArray[indexPath.row]
            return cell
        }
